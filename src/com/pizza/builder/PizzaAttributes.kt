...
sealed class Size: PizzaAttribute() {
    object Small : Size() {
        ...
        override fun getCost() = 100.00
    }

    object Medium : Size() {
        override fun getName() = "Medium Size Pizza"
        override fun getCost() = 200.00
    }

    object Large : Size() {
        override fun getName() = "Large Size Pizza"
        override fun getCost() = 300.00
    }
}
...
sealed class Crust: PizzaAttribute() {
    ...
    object Stuffed : Crust() {
        ...
        override fun getCost() = 50.00
    }

    object Thick : Crust() {
        override fun getName() = "Thick Crust"
        override fun getCost() = 40.00
    }
}
